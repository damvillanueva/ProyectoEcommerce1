...
setError("No tienes permisos para crear o modificar inventario.");
return;
}
...
if (!canManageInventory) {
setError("No tienes permisos para editar inventario.");
return;
}
...
setError("Solo un administrador puede eliminar inventario.");
return;
}
...
function ProductDetailModal({ item, movements, loading, error, onClose }) {
